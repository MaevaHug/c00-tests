...
cc -Wall -Wextra -Werror -o ft_print_numbers ft_print_numbers.c main.c
if [ $? -ne 0 ]; then
...
longest_test="$> ./ft_print_numbers | cat -e"
...
run_test() {
	...
	echo "$separator"
	echo "$> ./ft_print_numbers | cat -e"

	output=$(./ft_print_numbers | cat -e)
...
run_test "0123456789" || all_tests_passed=false
