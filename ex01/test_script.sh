...
cc -Wall -Wextra -Werror -o ft_print_alphabet ft_print_alphabet.c main.c
if [ $? -ne 0 ]; then
...
longest_test="$> ./ft_print_alphabet | cat -e"
...
run_test() {
	...
	echo "$separator"
	echo "$> ./ft_print_alphabet | cat -e"
	output=$(./ft_print_alphabet | cat -e)
...
run_test "abcdefghijklmnopqrstuvwxyz" || all_tests_passed=false
